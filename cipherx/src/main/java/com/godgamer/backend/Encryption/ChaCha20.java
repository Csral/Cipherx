...
public class ChaCha20 {
    ...
    private IvParameterSpec ivSpec; //* Param spec, named as iv for sake of convenience. */
    ...
    public String encrypt(String plaintext) throws Exception {
        ...
        byte[] ivBytes = this.ivSpec.getIV();
        ChaCha20ParameterSpec c20spec = new ChaCha20ParameterSpec(ivBytes, 1);
